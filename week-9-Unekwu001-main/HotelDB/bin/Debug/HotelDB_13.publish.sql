...
GO
PRINT N'Altering Table [dbo].[hotels]...';


GO
ALTER TABLE [dbo].[hotels]
    ADD [hotelImageUrl2]   VARCHAR (500) NULL,
        [hotelImageUrl3]   VARCHAR (500) NULL,
        [hotelAboutDPlace] VARCHAR (MAX) NULL,
        [bedRoom]          INT           NULL,
        [livingRoom]       INT           NULL,
        [bathRoom]         INT           NULL,
        [dinningRoom]      INT           NULL,
        [mbps]             INT           NULL,
        [unitsReady]       INT           NULL,
        [refrigerator]     INT           NULL,
        [television]       INT           NULL;


GO
PRINT N'Refreshing Procedure [dbo].[GetAllHotels]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[GetAllHotels]';
